...
<%
						...
						Do While Not ObjRs.EOF 
										...
										If ObjRS.Fields("REF_3_ESPECIALIDAD_SELECCIONADA_CICLO_2").Value=RefClaveGrupo  then
												
												ContarRegistros2=ContarRegistros2+1
						...
						Else
								...
								NumTotalPages= Round(ContarRegistros2/28,2)
...
Sub Cabecera()
						...
						PDF.Text 260, 21, "Encontrados:  " + CStr(ContarRegistros2)
						...
						PDF.Text 200, 45 ,  "(SEGUNDO CUATRIMESTRE)"
End Sub					
